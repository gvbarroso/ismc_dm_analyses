...
knitr::opts_knit$set(root.dir = "~/Data/iSMC/theta_paper/root/")
...
```{r, message=FALSE, warning=FALSE}
rep_1.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.diversity.50kb.bedgraph", header = T)
rep_1.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.rho.50kb.bedgraph", header = T)
rep_1.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.theta.50kb.bedgraph", header = T)
rep_1.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.TMRCA.50kb.bedgraph", header = T)
rep_1.tmrca.50kb$avg <- apply(rep_1.tmrca.50kb[4:ncol(rep_1.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep1 <- as.data.frame(cbind(rep_1.pi.50kb$pi, rep_1.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_1.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep1) <- c("diversity", "theta", "rho", "tmrca")
...
# centering
sim.lands.50kb.rep1.rep1$thetaC <- sim.lands.50kb.rep1$theta - mean(sim.lands.50kb.rep1$theta)
...
```{r, message=FALSE, warning=FALSE}
rep_2.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep2_5.diversity.50kb.bedgraph", header = T)
rep_2.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep2_5.rho.50kb.bedgraph", header = T)
rep_2.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep2_5.theta.50kb.bedgraph", header = T)
rep_2.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep2_5.TMRCA.50kb.bedgraph", header = T)
rep_2.tmrca.50kb$avg <- apply(rep_2.tmrca.50kb[4:ncol(rep_2.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep2 <- as.data.frame(cbind(rep_2.pi.50kb$pi, rep_2.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_2.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep2) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_3.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep3_5.diversity.50kb.bedgraph", header = T)
rep_3.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep3_5.rho.50kb.bedgraph", header = T)
rep_3.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep3_5.theta.50kb.bedgraph", header = T)
rep_3.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep3_5.TMRCA.50kb.bedgraph", header = T)
rep_3.tmrca.50kb$avg <- apply(rep_3.tmrca.50kb[4:ncol(rep_3.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep3 <- as.data.frame(cbind(rep_3.pi.50kb$pi, rep_3.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_3.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep3) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_4.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep4_5.diversity.50kb.bedgraph", header = T)
rep_4.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep4_5.rho.50kb.bedgraph", header = T)
rep_4.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep4_5.theta.50kb.bedgraph", header = T)
rep_4.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep4_5.TMRCA.50kb.bedgraph", header = T)
rep_4.tmrca.50kb$avg <- apply(rep_4.tmrca.50kb[4:ncol(rep_4.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep4 <- as.data.frame(cbind(rep_4.pi.50kb$pi, rep_4.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_4.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep4) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_5.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.diversity.50kb.bedgraph", header = T)
rep_5.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.rho.50kb.bedgraph", header = T)
rep_5.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.theta.50kb.bedgraph", header = T)
rep_5.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep5_5.TMRCA.50kb.bedgraph", header = T)
rep_5.tmrca.50kb$avg <- apply(rep_5.tmrca.50kb[4:ncol(rep_5.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep5 <- as.data.frame(cbind(rep_5.pi.50kb$pi, rep_5.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_5.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep5) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_6.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep6_5.diversity.50kb.bedgraph", header = T)
rep_6.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep6_5.rho.50kb.bedgraph", header = T)
rep_6.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep6_5.theta.50kb.bedgraph", header = T)
rep_6.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep6_5.TMRCA.50kb.bedgraph", header = T)
rep_6.tmrca.50kb$avg <- apply(rep_6.tmrca.50kb[4:ncol(rep_6.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep6 <- as.data.frame(cbind(rep_6.pi.50kb$pi, rep_6.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_6.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep6) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_7.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep7_5.diversity.50kb.bedgraph", header = T)
rep_7.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep7_5.rho.50kb.bedgraph", header = T)
rep_7.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep7_5.theta.50kb.bedgraph", header = T)
rep_7.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep7_5.TMRCA.50kb.bedgraph", header = T)
rep_7.tmrca.50kb$avg <- apply(rep_7.tmrca.50kb[4:ncol(rep_7.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep7 <- as.data.frame(cbind(rep_7.pi.50kb$pi, rep_7.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_7.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep7) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_8.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep8_5.diversity.50kb.bedgraph", header = T)
rep_8.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep8_5.rho.50kb.bedgraph", header = T)
rep_8.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep8_5.theta.50kb.bedgraph", header = T)
rep_8.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep8_5.TMRCA.50kb.bedgraph", header = T)
rep_8.tmrca.50kb$avg <- apply(rep_8.tmrca.50kb[4:ncol(rep_8.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep8 <- as.data.frame(cbind(rep_8.pi.50kb$pi, rep_8.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_8.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep8) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_9.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep9_5.diversity.50kb.bedgraph", header = T)
rep_9.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep9_5.rho.50kb.bedgraph", header = T)
rep_9.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep9_5.theta.50kb.bedgraph", header = T)
rep_9.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep9_5.TMRCA.50kb.bedgraph", header = T)
rep_9.tmrca.50kb$avg <- apply(rep_9.tmrca.50kb[4:ncol(rep_9.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep9 <- as.data.frame(cbind(rep_9.pi.50kb$pi, rep_9.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_9.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep9) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
rep_10.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep10_5.diversity.50kb.bedgraph", header = T)
rep_10.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep10_5.rho.50kb.bedgraph", header = T)
rep_10.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep10_5.theta.50kb.bedgraph", header = T)
rep_10.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/dm2L_bgs_rep10_5.TMRCA.50kb.bedgraph", header = T)
rep_10.tmrca.50kb$avg <- apply(rep_10.tmrca.50kb[4:ncol(rep_10.tmrca.50kb)], 1, mean)

sim.lands.50kb.rep10 <- as.data.frame(cbind(rep_10.pi.50kb$pi, rep_10.tmrca.50kb$avg, sim.rho.50kb$sample_mean, rep_10.tmrca.50kb$sample_mean))
names(sim.lands.50kb.rep10) <- c("diversity", "theta", "rho", "tmrca")
...
```{r, message=FALSE, warning=FALSE}
sim.lands.50kb.all <- rbind(sim.lands.50kb.rep1, sim.lands.50kb.rep2, sim.lands.50kb.rep3, sim.lands.50kb.rep4, sim.lands.50kb.rep5, sim.lands.50kb.rep6, sim.lands.50kb.rep7, sim.lands.50kb.rep8, sim.lands.50kb.rep9, sim.lands.50kb.rep50)
