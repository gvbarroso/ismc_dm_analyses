...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep2 <- as.data.frame(cbind(rep_2.pi.50kb$avg, sim.theta.50kb$Rate, rep2.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep3 <- as.data.frame(cbind(rep_3.pi.50kb$avg, sim.theta.50kb$Rate, rep3.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep4 <- as.data.frame(cbind(rep_4.pi.50kb$avg, sim.theta.50kb$Rate, rep4.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep5 <- as.data.frame(cbind(rep_5.pi.50kb$avg, sim.theta.50kb$Rate, rep5.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep6 <- as.data.frame(cbind(rep_6.pi.50kb$avg, sim.theta.50kb$Rate, rep6.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep7 <- as.data.frame(cbind(rep_7.pi.50kb$avg, sim.theta.50kb$Rate, rep7.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep8 <- as.data.frame(cbind(rep_8.pi.50kb$avg, sim.theta.50kb$Rate, rep8.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep9 <- as.data.frame(cbind(rep_9.pi.50kb$avg, sim.theta.50kb$Rate, rep9.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.50kb.rep10 <- as.data.frame(cbind(rep_10.pi.50kb$avg, sim.theta.50kb$Rate, rep10.sim.tmrca.50kb$AverageTmrca, sim.rho.50kb$Rate))
...
theta.map.50kb.bgs <- theta.map.50kb.bgs + scale_x_continuous(breaks = c(5000, 10000, 15000, 20000)) + scale_y_continuous(breaks = pretty_breaks(), labels = scale.3d)
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep2 <- as.data.frame(cbind(rep_2.pi.200kb$avg, sim.theta.200kb$Rate, rep2.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep3 <- as.data.frame(cbind(rep_3.pi.200kb$avg, sim.theta.200kb$Rate, rep3.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep4 <- as.data.frame(cbind(rep_4.pi.200kb$avg, sim.theta.200kb$Rate, rep4.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep5 <- as.data.frame(cbind(rep_5.pi.200kb$avg, sim.theta.200kb$Rate, rep5.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep6 <- as.data.frame(cbind(rep_6.pi.200kb$avg, sim.theta.200kb$Rate, rep6.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep7 <- as.data.frame(cbind(rep_7.pi.200kb$avg, sim.theta.200kb$Rate, rep7.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep8 <- as.data.frame(cbind(rep_8.pi.200kb$avg, sim.theta.200kb$Rate, rep8.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep9 <- as.data.frame(cbind(rep_9.pi.200kb$avg, sim.theta.200kb$Rate, rep9.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.200kb.rep10 <- as.data.frame(cbind(rep_10.pi.200kb$avg, sim.theta.200kb$Rate, rep10.sim.tmrca.200kb$AverageTmrca, sim.rho.200kb$Rate))
...
theta.map.200kb.bgs <- theta.map.200kb.bgs + scale_x_continuous(breaks = c(5000, 10000, 15000, 20000)) + scale_y_continuous(breaks = pretty_breaks(), labels = scale.3d)
...
# first the linear modeling with the true (simulated) landscapes
true.lands.1Mb.rep3 <- as.data.frame(cbind(rep_3.pi.1Mb$avg, sim.theta.1Mb$Rate, rep3.sim.tmrca.1Mb$AverageTmrca, sim.rho.1Mb$Rate))
...
# first the linear modeling with the true (simulated) landscapes
true.lands.1Mb.rep5 <- as.data.frame(cbind(rep_5.pi.1Mb$avg, sim.theta.1Mb$Rate, rep5.sim.tmrca.1Mb$AverageTmrca, sim.rho.1Mb$Rate))
...
theta.map.1Mb.bgs <- theta.map.1Mb.bgs + scale_x_continuous(breaks = c(5000, 10000, 15000, 20000)) + scale_y_continuous(breaks = pretty_breaks(), labels = scale.3d)
...
save_plot("Figure2.pdf", theta.maps.comb, base_height = 18, base_width = 14)
