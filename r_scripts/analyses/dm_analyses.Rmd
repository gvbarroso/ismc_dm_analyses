...
knitr::opts_knit$set(root.dir = "~/Data/root/")
...
# Simulations with BGS in SLiM (iSMC-inferred landscapes)
...
sim.theta.50kb <- read.table("bgs/Droso/MutationMap_50kb.csv", header = T)
sim.rho.50kb <- read.table("bgs/Droso/RecombinationMap_50kb.csv", header = T)
```

### Replicate 1

```{r, message=FALSE, warning=FALSE}
rep_1.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.diversity.50kb.bedgraph", header = T)
rep_1.pi.50kb$avg <- apply(rep_1.pi.50kb[4:ncol(rep_1.pi.50kb)], 1, mean)
rep_1.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.rho.50kb.bedgraph", header = T)
rep_1.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.theta.50kb.bedgraph", header = T)
rep_1.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep1, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep1, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep1, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep1.rep5 <- sim.lands.50kb.rep1
sim.lands.50kb.rep1.rep5$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_2.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.diversity.50kb.bedgraph", header = T)
rep_2.pi.50kb$avg <- apply(rep_2.pi.50kb[4:ncol(rep_2.pi.50kb)], 1, mean)
rep_2.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.rho.50kb.bedgraph", header = T)
rep_2.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.theta.50kb.bedgraph", header = T)
rep_2.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep2, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep2, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep2, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep2.rep2 <- sim.lands.50kb.rep2
sim.lands.50kb.rep2.rep2$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_3.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.diversity.50kb.bedgraph", header = T)
rep_3.pi.50kb$avg <- apply(rep_3.pi.50kb[4:ncol(rep_3.pi.50kb)], 1, mean)
rep_3.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.rho.50kb.bedgraph", header = T)
rep_3.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.theta.50kb.bedgraph", header = T)
rep_3.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep3, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep3, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep3, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep3.rep3 <- sim.lands.50kb.rep3
sim.lands.50kb.rep3.rep3$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_4.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.diversity.50kb.bedgraph", header = T)
rep_4.pi.50kb$avg <- apply(rep_4.pi.50kb[4:ncol(rep_4.pi.50kb)], 1, mean)
rep_4.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.rho.50kb.bedgraph", header = T)
rep_4.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.theta.50kb.bedgraph", header = T)
rep_4.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep4, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep4, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep4, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep4.rep4 <- sim.lands.50kb.rep4
sim.lands.50kb.rep4.rep4$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_5.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.diversity.50kb.bedgraph", header = T)
rep_5.pi.50kb$avg <- apply(rep_5.pi.50kb[4:ncol(rep_5.pi.50kb)], 1, mean)
rep_5.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.rho.50kb.bedgraph", header = T)
rep_5.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.theta.50kb.bedgraph", header = T)
rep_5.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep5, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep5, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep5, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep5.rep5 <- sim.lands.50kb.rep5
sim.lands.50kb.rep5.rep5$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_6.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.diversity.50kb.bedgraph", header = T)
rep_6.pi.50kb$avg <- apply(rep_6.pi.50kb[4:ncol(rep_6.pi.50kb)], 1, mean)
rep_6.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.rho.50kb.bedgraph", header = T)
rep_6.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.theta.50kb.bedgraph", header = T)
rep_6.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep6, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep6, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep6, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep6.rep6 <- sim.lands.50kb.rep6
sim.lands.50kb.rep6.rep6$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_7.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.diversity.50kb.bedgraph", header = T)
rep_7.pi.50kb$avg <- apply(rep_7.pi.50kb[4:ncol(rep_7.pi.50kb)], 1, mean)
rep_7.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.rho.50kb.bedgraph", header = T)
rep_7.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.theta.50kb.bedgraph", header = T)
rep_7.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep7, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep7, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep7, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep7.rep7 <- sim.lands.50kb.rep7
sim.lands.50kb.rep7.rep7$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_8.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.diversity.50kb.bedgraph", header = T)
rep_8.pi.50kb$avg <- apply(rep_8.pi.50kb[4:ncol(rep_8.pi.50kb)], 1, mean)
rep_8.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.rho.50kb.bedgraph", header = T)
rep_8.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.theta.50kb.bedgraph", header = T)
rep_8.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep8, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep8, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep8, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep8.rep8 <- sim.lands.50kb.rep8
sim.lands.50kb.rep8.rep8$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_9.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.diversity.50kb.bedgraph", header = T)
rep_9.pi.50kb$avg <- apply(rep_9.pi.50kb[4:ncol(rep_9.pi.50kb)], 1, mean)
rep_9.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.rho.50kb.bedgraph", header = T)
rep_9.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.theta.50kb.bedgraph", header = T)
rep_9.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep9, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep9, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep9, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep9.rep9 <- sim.lands.50kb.rep9
sim.lands.50kb.rep9.rep9$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_10.pi.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.diversity.50kb.bedgraph", header = T)
rep_10.pi.50kb$avg <- apply(rep_10.pi.50kb[4:ncol(rep_10.pi.50kb)], 1, mean)
rep_10.rho.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.rho.50kb.bedgraph", header = T)
rep_10.theta.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.theta.50kb.bedgraph", header = T)
rep_10.tmrca.50kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.TMRCA.50kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.50kb.rep10, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.50kb.rep10, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.50kb.rep10, method = "spearman") 
...
# for merging:
sim.lands.50kb.rep10.rep10 <- sim.lands.50kb.rep10
sim.lands.50kb.rep10.rep10$Replicate <- 1
...
sim.theta.200kb <- read.table("bgs/Droso/MutationMap_200kb.csv", header = T)
sim.rho.200kb <- read.table("bgs/Droso/RecombinationMap_200kb.csv", header = T)
```

### Replicate 1

```{r, message=FALSE, warning=FALSE}
rep_1.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.diversity.200kb.bedgraph", header = T)
rep_1.pi.200kb$avg <- apply(rep_1.pi.200kb[4:ncol(rep_1.pi.200kb)], 1, mean)
rep_1.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.rho.200kb.bedgraph", header = T)
rep_1.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.theta.200kb.bedgraph", header = T)
rep_1.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep1, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep1, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep1, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep1.rep5 <- sim.lands.200kb.rep1
sim.lands.200kb.rep1.rep5$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_2.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.diversity.200kb.bedgraph", header = T)
rep_2.pi.200kb$avg <- apply(rep_2.pi.200kb[4:ncol(rep_2.pi.200kb)], 1, mean)
rep_2.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.rho.200kb.bedgraph", header = T)
rep_2.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.theta.200kb.bedgraph", header = T)
rep_2.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep2, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep2, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep2, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep2.rep2 <- sim.lands.200kb.rep2
sim.lands.200kb.rep2.rep2$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_3.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.diversity.200kb.bedgraph", header = T)
rep_3.pi.200kb$avg <- apply(rep_3.pi.200kb[4:ncol(rep_3.pi.200kb)], 1, mean)
rep_3.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.rho.200kb.bedgraph", header = T)
rep_3.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.theta.200kb.bedgraph", header = T)
rep_3.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep3, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep3, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep3, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep3.rep3 <- sim.lands.200kb.rep3
sim.lands.200kb.rep3.rep3$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_4.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.diversity.200kb.bedgraph", header = T)
rep_4.pi.200kb$avg <- apply(rep_4.pi.200kb[4:ncol(rep_4.pi.200kb)], 1, mean)
rep_4.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.rho.200kb.bedgraph", header = T)
rep_4.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.theta.200kb.bedgraph", header = T)
rep_4.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep4, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep4, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep4, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep4.rep4 <- sim.lands.200kb.rep4
sim.lands.200kb.rep4.rep4$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_5.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.diversity.200kb.bedgraph", header = T)
rep_5.pi.200kb$avg <- apply(rep_5.pi.200kb[4:ncol(rep_5.pi.200kb)], 1, mean)
rep_5.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.rho.200kb.bedgraph", header = T)
rep_5.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.theta.200kb.bedgraph", header = T)
rep_5.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep5, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep5, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep5, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep5.rep5 <- sim.lands.200kb.rep5
sim.lands.200kb.rep5.rep5$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_6.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.diversity.200kb.bedgraph", header = T)
rep_6.pi.200kb$avg <- apply(rep_6.pi.200kb[4:ncol(rep_6.pi.200kb)], 1, mean)
rep_6.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.rho.200kb.bedgraph", header = T)
rep_6.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.theta.200kb.bedgraph", header = T)
rep_6.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep6, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep6, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep6, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep6.rep6 <- sim.lands.200kb.rep6
sim.lands.200kb.rep6.rep6$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_7.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.diversity.200kb.bedgraph", header = T)
rep_7.pi.200kb$avg <- apply(rep_7.pi.200kb[4:ncol(rep_7.pi.200kb)], 1, mean)
rep_7.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.rho.200kb.bedgraph", header = T)
rep_7.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.theta.200kb.bedgraph", header = T)
rep_7.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep7, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep7, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep7, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep7.rep7 <- sim.lands.200kb.rep7
sim.lands.200kb.rep7.rep7$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_8.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.diversity.200kb.bedgraph", header = T)
rep_8.pi.200kb$avg <- apply(rep_8.pi.200kb[4:ncol(rep_8.pi.200kb)], 1, mean)
rep_8.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.rho.200kb.bedgraph", header = T)
rep_8.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.theta.200kb.bedgraph", header = T)
rep_8.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep8, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep8, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep8, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep8.rep8 <- sim.lands.200kb.rep8
sim.lands.200kb.rep8.rep8$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_9.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.diversity.200kb.bedgraph", header = T)
rep_9.pi.200kb$avg <- apply(rep_9.pi.200kb[4:ncol(rep_9.pi.200kb)], 1, mean)
rep_9.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.rho.200kb.bedgraph", header = T)
rep_9.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.theta.200kb.bedgraph", header = T)
rep_9.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep9, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep9, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep9, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep9.rep9 <- sim.lands.200kb.rep9
sim.lands.200kb.rep9.rep9$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_10.pi.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.diversity.200kb.bedgraph", header = T)
rep_10.pi.200kb$avg <- apply(rep_10.pi.200kb[4:ncol(rep_10.pi.200kb)], 1, mean)
rep_10.rho.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.rho.200kb.bedgraph", header = T)
rep_10.theta.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.theta.200kb.bedgraph", header = T)
rep_10.tmrca.200kb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.TMRCA.200kb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.200kb.rep10, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.200kb.rep10, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.200kb.rep10, method = "spearman") 
...
# for merging:
sim.lands.200kb.rep10.rep10 <- sim.lands.200kb.rep10
sim.lands.200kb.rep10.rep10$Replicate <- 1
...
sim.theta.1Mb <- read.table("bgs/Droso/MutationMap_1000kb.csv", header = T)
sim.rho.1Mb <- read.table("bgs/Droso/RecombinationMap_1000kb.csv", header = T)
```

### Replicate 1

```{r, message=FALSE, warning=FALSE}
rep_1.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.diversity.1Mb.bedgraph", header = T)
rep_1.pi.1Mb$avg <- apply(rep_1.pi.1Mb[4:ncol(rep_1.pi.1Mb)], 1, mean)
rep_1.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.rho.1Mb.bedgraph", header = T)
rep_1.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.theta.1Mb.bedgraph", header = T)
rep_1.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep1/dm2L_bgs_rep1_5.TMRCA.1Mb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.1Mb.rep1, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.1Mb.rep1, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.1Mb.rep1, method = "spearman") 
...
# for merging:
sim.lands.1Mb.rep1.rep5 <- sim.lands.1Mb.rep1
sim.lands.1Mb.rep1.rep5$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_2.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.diversity.1Mb.bedgraph", header = T)
rep_2.pi.1Mb$avg <- apply(rep_2.pi.1Mb[4:ncol(rep_2.pi.1Mb)], 1, mean)
rep_2.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.rho.1Mb.bedgraph", header = T)
rep_2.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.theta.1Mb.bedgraph", header = T)
rep_2.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep2/dm2L_bgs_rep2_5.TMRCA.1Mb.bedgraph", header = T)
...
cor.test(~theta+tmrca, data = sim.lands.1Mb.rep2, method = "spearman") 
cor.test(~theta+rho, data = sim.lands.1Mb.rep2, method = "spearman") 
cor.test(~rho+tmrca, data = sim.lands.1Mb.rep2, method = "spearman") 
...
# for merging:
sim.lands.1Mb.rep2.rep2 <- sim.lands.1Mb.rep2
sim.lands.1Mb.rep2.rep2$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_3.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.diversity.1Mb.bedgraph", header = T)
rep_3.pi.1Mb$avg <- apply(rep_3.pi.1Mb[4:ncol(rep_3.pi.1Mb)], 1, mean)
rep_3.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.rho.1Mb.bedgraph", header = T)
rep_3.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.theta.1Mb.bedgraph", header = T)
rep_3.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep3/dm2L_bgs_rep3_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep3.rep3 <- sim.lands.1Mb.rep3
sim.lands.1Mb.rep3.rep3$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_4.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.diversity.1Mb.bedgraph", header = T)
rep_4.pi.1Mb$avg <- apply(rep_4.pi.1Mb[4:ncol(rep_4.pi.1Mb)], 1, mean)
rep_4.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.rho.1Mb.bedgraph", header = T)
rep_4.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.theta.1Mb.bedgraph", header = T)
rep_4.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep4/dm2L_bgs_rep4_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep4.rep4 <- sim.lands.1Mb.rep4
sim.lands.1Mb.rep4.rep4$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_5.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.diversity.1Mb.bedgraph", header = T)
rep_5.pi.1Mb$avg <- apply(rep_5.pi.1Mb[4:ncol(rep_5.pi.1Mb)], 1, mean)
rep_5.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.rho.1Mb.bedgraph", header = T)
rep_5.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.theta.1Mb.bedgraph", header = T)
rep_5.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep5/dm2L_bgs_rep5_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep5.rep5 <- sim.lands.1Mb.rep5
sim.lands.1Mb.rep5.rep5$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_6.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.diversity.1Mb.bedgraph", header = T)
rep_6.pi.1Mb$avg <- apply(rep_6.pi.1Mb[4:ncol(rep_6.pi.1Mb)], 1, mean)
rep_6.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.rho.1Mb.bedgraph", header = T)
rep_6.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.theta.1Mb.bedgraph", header = T)
rep_6.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep6.rep6 <- sim.lands.1Mb.rep6
sim.lands.1Mb.rep6.rep6$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_7.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.diversity.1Mb.bedgraph", header = T)
rep_7.pi.1Mb$avg <- apply(rep_7.pi.1Mb[4:ncol(rep_7.pi.1Mb)], 1, mean)
rep_7.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.rho.1Mb.bedgraph", header = T)
rep_7.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.theta.1Mb.bedgraph", header = T)
rep_7.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep6/dm2L_bgs_rep6_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep7.rep7 <- sim.lands.1Mb.rep7
sim.lands.1Mb.rep7.rep7$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_8.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.diversity.1Mb.bedgraph", header = T)
rep_8.pi.1Mb$avg <- apply(rep_8.pi.1Mb[4:ncol(rep_8.pi.1Mb)], 1, mean)
rep_8.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.rho.1Mb.bedgraph", header = T)
rep_8.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.theta.1Mb.bedgraph", header = T)
rep_8.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep8/dm2L_bgs_rep8_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep8.rep8 <- sim.lands.1Mb.rep8
sim.lands.1Mb.rep8.rep8$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_9.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.diversity.1Mb.bedgraph", header = T)
rep_9.pi.1Mb$avg <- apply(rep_9.pi.1Mb[4:ncol(rep_9.pi.1Mb)], 1, mean)
rep_9.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.rho.1Mb.bedgraph", header = T)
rep_9.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.theta.1Mb.bedgraph", header = T)
rep_9.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep9/dm2L_bgs_rep9_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep9.rep9 <- sim.lands.1Mb.rep9
sim.lands.1Mb.rep9.rep9$Replicate <- 1
...
```{r, message=FALSE, warning=FALSE}
rep_10.pi.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.diversity.1Mb.bedgraph", header = T)
rep_10.pi.1Mb$avg <- apply(rep_10.pi.1Mb[4:ncol(rep_10.pi.1Mb)], 1, mean)
rep_10.rho.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.rho.1Mb.bedgraph", header = T)
rep_10.theta.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.theta.1Mb.bedgraph", header = T)
rep_10.tmrca.1Mb <- read.table("bgs/Droso/10r/Homogeneous/iSMC/NonHomogeneous/rep10/dm2L_bgs_rep10_5.TMRCA.1Mb.bedgraph", header = T)
...
# for merging:
sim.lands.1Mb.rep10.rep10 <- sim.lands.1Mb.rep10
sim.lands.1Mb.rep10.rep10$Replicate <- 1
...
colnames(r2.inf.avg) <- c("Total", "Theta", "Rho", "TMRCA")
r2.inf.avg$bin.size <- c(50, 200, 1000)
