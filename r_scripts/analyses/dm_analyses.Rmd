...
```{r, message=FALSE, warning=FALSE}
# loads data
dm.raw <- read.table("dm_data/dm_misc/dpgp3_Dyak_bpp.all.csv", header = T, fill = T, stringsAsFactors = T) %>% na.omit()
...
dm.tbl.popgen <- as.data.frame(cbind(dm.tbl$PiN, dm.tbl$PiS, dm.tbl$dN, dm.tbl$dS, dm.tbl$GeneID)) %>% na.omit()
...
dm.tbl.popstats <- cbind.data.frame(as.character(dm.tbl.genes$geneID),
                                    dm.tbl.genes$PiN,
                                    dm.tbl.genes$PiS,
                                    dm.tbl.genes$PiNPiS,
                                    dm.tbl.genes$dN,
...
dm.lands.evolrate <- arrange(dm.lands.evolrate, chr, start.window)
