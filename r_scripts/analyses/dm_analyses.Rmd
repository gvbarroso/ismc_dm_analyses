...
theta.map.50kb <- theta.map.50kb + labs(title = NULL, x = NULL, y = expression(theta))
theta.map.50kb <- theta.map.50kb + geom_segment(data = dm_2L_exome, aes(x = exon_start, xend = exon_end, y = 0, yend = 0, size = 2))
...
tau.map.50kb <- ggplot(data = molten.tau, aes(x = bin * 5e+4, y = value / (4 * 1e+4), colour = variable))
...
theta.map.200kb <- theta.map.200kb + geom_segment(data = dm_2L_exome, aes(x = exon_start, xend = exon_end, y = 0, yend = 0, size = 2))
...
tau.map.200kb <- ggplot(data = molten.tau, aes(x = bin * 2e+5, y = value / (4 * 1e+4), colour = variable))
...
theta.map.1Mb <- theta.map.1Mb + geom_segment(data = dm_2L_exome, aes(x = exon_start, xend = exon_end, y = 0, yend = 0, size = 2))
...
tau.map.1Mb <- ggplot(data = molten.tau, aes(x = bin * 1e+6, y = value / (4 * 1e+4), colour = variable))
