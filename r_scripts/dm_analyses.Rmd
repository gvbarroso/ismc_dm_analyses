...
First batch of 10 replicate simulations using parameters as inferred from real
Drosophila data.
...
# sim landscapes
sim.rho.50k <- read.table("dm_data/dm_chr_maps/2L/dm_coal_sims/dm.sim.rho.50000.txt")
sim.theta.50k <- read.table("dm_data/dm_chr_maps/2L/dm_coal_sims/dm.sim.theta.50000.txt")
...
# sim landscapes
sim.rho.200k <- read.table("dm_data/dm_chr_maps/2L/dm_coal_sims/dm.sim.rho.2e+05.txt")
sim.theta.200k <- read.table("dm_data/dm_chr_maps/2L/dm_coal_sims/dm.sim.theta.2e+05.txt")
...
# sim landscapes
sim.rho.1M <- read.table("dm_data/dm_chr_maps/2L/dm_coal_sims/dm.sim.rho.1e+06.txt")
sim.theta.1M <- read.table("dm_data/dm_chr_maps/2L/dm_coal_sims/dm.sim.theta.1e+06.txt")
...
We focus on chr 2L for comparing R^2 with simulations
...
Real Drosophila data -- whole-genome analyses
...
We can read the table provided:
