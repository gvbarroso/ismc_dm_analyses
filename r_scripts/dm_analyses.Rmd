---
title: "Determinants of the genome-wide diversity in Drosophila"
...
rho.plot <- as.data.frame(cbind(inf.lands.50k.rep_1$bin,
                                sim.rho.50k$sim, 
...
theta.plot <- as.data.frame(cbind(inf.lands.50k.rep_1$bin,
                                sim.theta.50k$sim, 
...
rho.plot <- as.data.frame(cbind(inf.lands.200k.rep_1$bin,
                                sim.rho.200k$sim, 
...
names(rho.plot) <- c("bin", "sim", reps)
molten.rho <- melt(rho.plot, id.vars = "bin")
rho.map.200kb <- ggplot(data = molten.rho, aes(x = bin * 50, y = value, colour = variable)) + theme_bw()
...
theta.plot <- as.data.frame(cbind(inf.lands.200k.rep_1$bin,
                                sim.theta.200k$sim, 
...
names(theta.plot) <- c("bin", "sim", reps)
molten.theta <- melt(theta.plot, id.vars = "bin")
theta.map.200kb <- ggplot(data = molten.theta, aes(x = bin * 50, y = value, colour = variable)) + theme_bw()
...
rho.plot <- as.data.frame(cbind(inf.lands.1M.rep_1$bin,
                                sim.rho.1M$sim, 
...
names(rho.plot) <- c("bin", "sim", reps)
molten.rho <- melt(rho.plot, id.vars = "bin")
rho.map.1Mb <- ggplot(data = molten.rho, aes(x = bin * 50, y = value, colour = variable)) + theme_bw()
...
theta.plot <- as.data.frame(cbind(inf.lands.1M.rep_1$bin,
                                sim.theta.1M$sim, 
...
names(theta.plot) <- c("bin", "sim", reps)
molten.theta <- melt(theta.plot, id.vars = "bin")
theta.map.1Mb <- ggplot(data = molten.theta, aes(x = bin * 50, y = value, colour = variable)) + theme_bw()
...
Real data chr 2L for comparing R^2 with simulations
...
write.table(dm.lands.50kb, "dm.maps.50kb.tsv", quote = F, sep = "\t", row.names = F, col.names = T)
...
write.table(dm.lands.200kb, "dm.maps.200kb.tsv", quote = F, sep = "\t", row.names = F, col.names = T)
...
write.table(dm.lands.1Mb, "dm.maps.1Mb.tsv", quote = F, sep = "\t", row.names = F, col.names = T)
...
divergence.2L.5kb <- read.table("~/Data/iSMC/theta_paper/dm_data/dm_misc/Droso2L_divergence.statistics5kb.csv", header = T)
divergence.2R.5kb <- read.table("~/Data/iSMC/theta_paper/dm_data/dm_misc/Droso2R_divergence.statistics5kb.csv", header = T)
divergence.3L.5kb <- read.table("~/Data/iSMC/theta_paper/dm_data/dm_misc/Droso3L_divergence.statistics5kb.csv", header = T)
divergence.3R.5kb <- read.table("~/Data/iSMC/theta_paper/dm_data/dm_misc/Droso3R_divergence.statistics5kb.csv", header = T)
...
write.table(lands.divergence.dm, "dm_maps_50kb_divergence.tsv",
...
```{r}
# loads 
dm.raw <- read.table("~/Data/iSMC/theta_paper/dm_data/dm_misc/dpgp3_Dyak_bpp.all.csv", header = T, fill = T, stringsAsFactors = T)
...
dm.genes.coord <- read.table("~/Data/iSMC/theta_paper/dm_data/dm_misc/Dmel_trans_nooverlaps-final.txt", header = F)
...
write.table(dm.lands.evolrate, "dm_maps_50kb_protein_rates.tsv",
...
Drosophila-like neutral simulations of 2L (True landscapes for plotting)
...
sim.rho.50kb <- read.table("rs_drosophila_2/Misc/dm.sim.rho.50000.txt", header = T)
sim.theta.50kb <- read.table("rs_drosophila_2/Misc/dm.sim.theta.50000.txt", header = T)

# rep 1
rep_1.pi.50kb <- read.table("rs_drosophila_2/rep_1/rep_1.pi.50kb.bedgraph", header = T)
rep_1.tmrca.50kb <- read.table("rs_drosophila_2/rep_1/sim.tmrca.50k.map", header = T)
...
# rep_2
rep_2.pi.50kb <- read.table("rs_drosophila_2/rep_2/rep_2.pi.50kb.bedgraph", header = T)
rep_2.tmrca.50kb <- read.table("rs_drosophila_2/rep_2/sim.tmrca.50k.map", header = T)
...
# rep_3
rep_3.pi.50kb <- read.table("rs_drosophila_2/rep_3/rep_3.pi.50kb.bedgraph", header = T)
rep_3.tmrca.50kb <- read.table("rs_drosophila_2/rep_3/sim.tmrca.50k.map", header = T)
...
# rep_4
rep_4.pi.50kb <- read.table("rs_drosophila_2/rep_4/rep_4.pi.50kb.bedgraph", header = T)
rep_4.tmrca.50kb <- read.table("rs_drosophila_2/rep_4/sim.tmrca.50k.map", header = T)
...
# rep_5
rep_5.pi.50kb <- read.table("rs_drosophila_2/rep_5/rep_5.pi.50kb.bedgraph", header = T)
rep_5.tmrca.50kb <- read.table("rs_drosophila_2/rep_5/sim.tmrca.50k.map", header = T)
...
# rep_6
rep_6.pi.50kb <- read.table("rs_drosophila_2/rep_6/rep_6.pi.50kb.bedgraph", header = T)
rep_6.tmrca.50kb <- read.table("rs_drosophila_2/rep_6/sim.tmrca.50k.map", header = T)
...
# rep_7
rep_7.pi.50kb <- read.table("rs_drosophila_2/rep_7/rep_7.pi.50kb.bedgraph", header = T)
rep_7.tmrca.50kb <- read.table("rs_drosophila_2/rep_7/sim.tmrca.50k.map", header = T)
...
# rep_8
rep_8.pi.50kb <- read.table("rs_drosophila_2/rep_8/rep_8.pi.50kb.bedgraph", header = T)
rep_8.tmrca.50kb <- read.table("rs_drosophila_2/rep_8/sim.tmrca.50k.map", header = T)
...
# rep_9
rep_9.pi.50kb <- read.table("rs_drosophila_2/rep_9/rep_9.pi.50kb.bedgraph", header = T)
rep_9.tmrca.50kb <- read.table("rs_drosophila_2/rep_9/sim.tmrca.50k.map", header = T)
...
# rep_10
rep_10.pi.50kb <- read.table("rs_drosophila_2/rep_10/rep_10.pi.50kb.bedgraph", header = T)
rep_10.tmrca.50kb <- read.table("rs_drosophila_2/rep_10/sim.tmrca.50k.map", header = T)
...
sim.rho.200kb <- read.table("rs_drosophila_2/Misc/dm.sim.rho.2e+05.txt", header = T)
sim.theta.200kb <- read.table("rs_drosophila_2/Misc/dm.sim.theta.2e+05.txt", header = T)

# rep 1
rep_1.pi.200kb <- read.table("rs_drosophila_2/rep_1/rep_1.pi.200kb.bedgraph", header = T)
rep_1.tmrca.200kb <- read.table("rs_drosophila_2/rep_1/sim.tmrca.200k.map", header = T)
...
# rep_2
rep_2.pi.200kb <- read.table("rs_drosophila_2/rep_2/rep_2.pi.200kb.bedgraph", header = T)
rep_2.tmrca.200kb <- read.table("rs_drosophila_2/rep_2/sim.tmrca.200k.map", header = T)
...
# rep_3
rep_3.pi.200kb <- read.table("rs_drosophila_2/rep_3/rep_3.pi.200kb.bedgraph", header = T)
rep_3.tmrca.200kb <- read.table("rs_drosophila_2/rep_3/sim.tmrca.200k.map", header = T)
...
# rep_4
rep_4.pi.200kb <- read.table("rs_drosophila_2/rep_4/rep_4.pi.200kb.bedgraph", header = T)
rep_4.tmrca.200kb <- read.table("rs_drosophila_2/rep_4/sim.tmrca.200k.map", header = T)
...
# rep_5
rep_5.pi.200kb <- read.table("rs_drosophila_2/rep_5/rep_5.pi.200kb.bedgraph", header = T)
rep_5.tmrca.200kb <- read.table("rs_drosophila_2/rep_5/sim.tmrca.200k.map", header = T)
...
# rep_6
rep_6.pi.200kb <- read.table("rs_drosophila_2/rep_6/rep_6.pi.200kb.bedgraph", header = T)
rep_6.tmrca.200kb <- read.table("rs_drosophila_2/rep_6/sim.tmrca.200k.map", header = T)
...
# rep_7
rep_7.pi.200kb <- read.table("rs_drosophila_2/rep_7/rep_7.pi.200kb.bedgraph", header = T)
rep_7.tmrca.200kb <- read.table("rs_drosophila_2/rep_7/sim.tmrca.200k.map", header = T)
...
# rep_8
rep_8.pi.200kb <- read.table("rs_drosophila_2/rep_8/rep_8.pi.200kb.bedgraph", header = T)
rep_8.tmrca.200kb <- read.table("rs_drosophila_2/rep_8/sim.tmrca.200k.map", header = T)
...
# rep_9
rep_9.pi.200kb <- read.table("rs_drosophila_2/rep_9/rep_9.pi.200kb.bedgraph", header = T)
rep_9.tmrca.200kb <- read.table("rs_drosophila_2/rep_9/sim.tmrca.200k.map", header = T)
...
# rep_10
rep_10.pi.200kb <- read.table("rs_drosophila_2/rep_10/rep_10.pi.200kb.bedgraph", header = T)
rep_10.tmrca.200kb <- read.table("rs_drosophila_2/rep_10/sim.tmrca.200k.map", header = T)
...
sim.rho.1Mb <- read.table("rs_drosophila_2/Misc/dm.sim.rho.1e+06.txt", header = T)
sim.theta.1Mb <- read.table("rs_drosophila_2/Misc/dm.sim.theta.1e+06.txt", header = T)

# rep 1
rep_1.pi.1Mb <- read.table("rs_drosophila_2/rep_1/rep_1.pi.1Mb.bedgraph", header = T)
rep_1.tmrca.1Mb <- read.table("rs_drosophila_2/rep_1/sim.tmrca.1M.map", header = T)
...
# rep_2
rep_2.pi.1Mb <- read.table("rs_drosophila_2/rep_2/rep_2.pi.1Mb.bedgraph", header = T)
rep_2.tmrca.1Mb <- read.table("rs_drosophila_2/rep_2/sim.tmrca.1M.map", header = T)
...
# rep_3
rep_3.pi.1Mb <- read.table("rs_drosophila_2/rep_3/rep_3.pi.1Mb.bedgraph", header = T)
rep_3.tmrca.1Mb <- read.table("rs_drosophila_2/rep_3/sim.tmrca.1M.map", header = T)
...
# rep_4
rep_4.pi.1Mb <- read.table("rs_drosophila_2/rep_4/rep_4.pi.1Mb.bedgraph", header = T)
rep_4.tmrca.1Mb <- read.table("rs_drosophila_2/rep_4/sim.tmrca.1M.map", header = T)
...
# rep_5
rep_5.pi.1Mb <- read.table("rs_drosophila_2/rep_5/rep_5.pi.1Mb.bedgraph", header = T)
rep_5.tmrca.1Mb <- read.table("rs_drosophila_2/rep_5/sim.tmrca.1M.map", header = T)
...
# rep_6
rep_6.pi.1Mb <- read.table("rs_drosophila_2/rep_6/rep_6.pi.1Mb.bedgraph", header = T)
rep_6.tmrca.1Mb <- read.table("rs_drosophila_2/rep_6/sim.tmrca.1M.map", header = T)
...
# rep_7
rep_7.pi.1Mb <- read.table("rs_drosophila_2/rep_7/rep_7.pi.1Mb.bedgraph", header = T)
rep_7.tmrca.1Mb <- read.table("rs_drosophila_2/rep_7/sim.tmrca.1M.map", header = T)
...
# rep_8
rep_8.pi.1Mb <- read.table("rs_drosophila_2/rep_8/rep_8.pi.1Mb.bedgraph", header = T)
rep_8.tmrca.1Mb <- read.table("rs_drosophila_2/rep_8/sim.tmrca.1M.map", header = T)
...
# rep_9
rep_9.pi.1Mb <- read.table("rs_drosophila_2/rep_9/rep_9.pi.1Mb.bedgraph", header = T)
rep_9.tmrca.1Mb <- read.table("rs_drosophila_2/rep_9/sim.tmrca.1M.map", header = T)
...
# rep_10
rep_10.pi.1Mb <- read.table("rs_drosophila_2/rep_10/rep_10.pi.1Mb.bedgraph", header = T)
rep_10.tmrca.1Mb <- read.table("rs_drosophila_2/rep_10/sim.tmrca.1M.map", header = T)
...
r2.tab.comb <- rbind.data.frame(r2.dm.tab.2, r2.sim.avg, r2.inf.avg)
...
fig4 <- plot_grid(r2.plot + theme(legend.position = "none", legend.title = NULL),
                  leg, nrow = 2, labels = NULL, rel_heights = c(1, 0.1), scale = c(1, 0.2))
fig4
```
