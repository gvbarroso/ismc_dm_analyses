...
if __name__ == "__main__":
    ...
    rec_positions = [int(x * 1e6) for x in [0, 5, 10, 15, 20, 25, 30]]
    rec_positions[-1] = rec_positions[-1] + 1
    rec_rates = [x * 1e-8 for x in [0.1, 1.5, 0.1, 1.5, 0.1, 1.5]]
    recomb_map = msprime.RateMap(position = rec_positions, rate = rec_rates)
